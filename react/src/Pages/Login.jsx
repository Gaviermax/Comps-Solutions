            ...
            <div className="container-fluid d-flex align-items-center justify-content-center bg-black" style={{minHeight: "100vh"}}>
                <div className="container d-flex align-items-center justify-evenly shadow rounded px-5 pb-5 text-white">
                    <div className="form p-3 d-flex align-items-center justify-content-center flex-column" style={{width:'100%'}}>
                        <h1 className="mb-5 fw-bold" style={{color:'#178582'}}>Comp<span className="text-white">Solution</span></h1>
                        <h1>Log In Account</h1>
                        <p>Don't have account yet? <Link to='/signup'><span className="fw-bold" style={{textDecoration:'underline', cursor:'pointer',color:'#178582'}}>Sign Up Now!</span></Link></p>
                        <p className="fw-semibold fs-5" style={{color:'#178582', letterSpacing:'1.5px'}}>Discover a great amount of new opportunities!</p>
