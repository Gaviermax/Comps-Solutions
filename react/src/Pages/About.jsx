            ...
            <div className="container-fluid bg-white text-black text-center p-5">
                ...
                <div className="d-flex my-5">
                    ...
                    <div className="col-4">
                        ...
                        <div className="links d-flex justify-content-center">
                            <Link to="#" target='_blank' className="text-purple mx-3 fs-3">
                                <FontAwesomeIcon icon={faFacebook}/>
                            </Link>
                            <Link to="#" target='_blank' className="text-purple mx-3 fs-3">
                                <FontAwesomeIcon icon={faGithub}/>
                ...
                <div className="d-flex my-5 py-5">
                    <div className="col-6">
                        <img className="img mx-auto mb-4" src="../src/images/carlos1_2.jpg" alt="" style={{maxWidth:"30%", borderRadius:"50%"}}/>
